  ...
  return (
    ...
    >
      <div className="relative h-56 overflow-hidden bg-gradient-to-br from-rose-100 via-amber-50 to-rose-50">
        ...
        <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/35 via-black/5 to-transparent p-4">
          <span className="inline-flex rounded-full border border-white/40 bg-white/80 px-3 py-1 text-[11px] font-semibold uppercase tracking-wider text-rose-800 backdrop-blur-sm">
            {product.imageLabel}
          </span>
        </div>
      </div>
